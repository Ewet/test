...
<div class='form'>
    <Form inline class="toolBarForm">
      <FormItem label='运营商'>
        <OperatorSelectInput v-model="filterObj.operatorId"/>
      </FormItem>
      <!-- <FormItem label='地区选择'>
        <AreaSelectInput v-model="filterObj.operatorId"/>
      </FormItem> -->
      ...
      <FormItem label='商户名称'>
        ...
        <MerchantSelectInput v-model="filterObj.nameSelect" keyName='merchantName'></MerchantSelectInput>
      </FormItem>
      <FormItem label='盒子编号'>
...
import { saleExportList, EXDetail } from './model';
...
export default {
  ...
  mounted () {
    ...
    this.filterData({
      ...
      plf_order_time_type: that.timeStyle,
      paid_status: '20',
      merchant_name: '',
      box_no: '',
      order_type: '',
  ...
  methods: {
    EXJudgeData () {
      ...
      const noTimeForm = {
        ...
        operator_id: filterItem.operatorId
      };
